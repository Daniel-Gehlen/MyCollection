package com.gehlen.colecao.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.gehlen.colecao.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.gehlen.colecao.security.DomainUserDetailsService", "createSpringSecurityUser");
